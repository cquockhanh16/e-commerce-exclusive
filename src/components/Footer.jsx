          ...
          <div className="space-y-4">
            ...
            <div className="flex">
              <input
                ...
                className="bg-black border border-white px-4 py-2 text-sm focus:outline-none"
              />
              <button className="border border-white border-l-0 px-3">
                {/* Arrow icon */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <div className="w-24 h-24 bg-white p-2">
                ...
                <img src="/api/placeholder/96/96" alt="QR Code" className="w-full h-full" />
              </div>
